...
if (!$campaign) {
    setFlashMessage('error', 'ChiÃ¡ÂºÂ¿n dÃ¡Â»?ch khÃƒÂ´ng tÃ¡Â»?n tÃ¡ÂºÂ¡i hoÃ¡ÂºÂ·c Ã„?ÃƒÂ£ kÃ¡ÂºÂ¿t thÃƒÂºc.');
    header('Location: campaigns.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($donate_type === 'campaign_item') {
        if ($campaign_item_id <= 0) {
            $error = 'Vui lÃ²ng chá»n váº­t pháº©m cáº§n quyÃªn gÃ³p trong chiáº¿n dá»‹ch';
        } else {
            ...
            if (!$campaignItem) {
                $error = 'VÃ¡ÂºÂ­t phÃ¡ÂºÂ©m chiÃ¡ÂºÂ¿n dÃ¡Â»?ch khÃƒÂ´ng tÃ¡Â»?n tÃ¡ÂºÂ¡i.';
            } else {
                $item_name = $campaignItem['item_name'];
                $category_id = (int)($campaignItem['category_id'] ?? 0);
                $unit = $campaignItem['unit'] ?: 'cÃƒÂ¡i';
...
$pageTitle = "QuyÃªn gÃ³p cho chi?n d?ch"; 
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <a href="campaign-detail.php?id=<?php echo $campaign_id; ?>" class="btn btn-sm btn-outline-primary">
                        <i class="bi bi-eye me-1"></i>Xem chi tiáº¿t chiáº¿n dá»‹ch</a>
                </div>
            </div>
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-success text-white">
                    <h2 class="card-title mb-0">
                        <i class="bi bi-gift me-2"></i>QuyÃªn gÃ³p cho chi?n d?ch 
                    </h2>
                </div>
